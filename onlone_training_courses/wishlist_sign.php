      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
          ...
          <div class="mainfild">
            ...
            <hr />
            <form action="wishlist_signup.php" name="registration" method="post" onSubmit="return checkPassword(this)">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="mainfild">
            ...
            <h4>Sign In</h4>
            <hr>
            <form action="wislist_signin.php" method="post" id="loginform">
              <input type="hidden" name="course_id" value="<?php echo $id; ?>">
